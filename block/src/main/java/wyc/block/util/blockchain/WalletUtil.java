...
public class WalletUtil {
     ...
     * @throws Exception
     */
    public static byte[] getAddress(Wallet wallet) throws BlockException{
    ...
    public static String getAddressString(Wallet wallet)throws BlockException{
     ...
     * @throws Exception
     */
    public static byte[] hashPubKey(byte[] pubKey) throws BlockException {
     ...
     * @return
     */
    public static boolean validateAddress(String address)throws BlockException{
        try{
            ...
            throw new BlockException(-1,"地址异常",e);
        }
     ...
     * @throws Exception
     */
    public static String createWallet() throws BlockException{
     ...
     * @throws Exception
     */
    private static void addToWallets(Wallet wallet) throws BlockException{
        String address =DataUtil.bytes2String(getAddress(wallet));
     ...
     * @throws Exception
     */
    public static void  printWallet()throws BlockException{
        logger.info("=====================遍历钱包===============================");
