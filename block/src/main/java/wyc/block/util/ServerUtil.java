...
public class ServerUtil {
    ...
    public static void startServer(String minerAddress) throws BlockException{
        ...
        new Server(NetConstant.commonPort).start();
    ...
    public static void sendData(String address,byte[] type,byte[] payload){
        ...
        Client.sendMessage(address,NetConstant.commonPort,data);
    }
