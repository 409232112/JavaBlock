...
public class TransactionUtil {
     ...
     * @return
     */
    public static Transaction getNewUTXOTransaction(Wallet wallet,String to,int amount) throws BlockException{
    ...
    */
     ...
     * @param address
     */
    public static int getBalance(String address) throws BlockException{
     ...
     * @param amount 发送数量
     */
    public static void send(String from ,String to ,int amount,boolean mineNow)throws BlockException {
     ...
     * @throws Exception
     */
    public static void signTransaction(Transaction transaction,ECPrivateKey ecPrivateKey) throws BlockException{
    ...
    public static void singn(Transaction tx,ECPrivateKey ecPrivateKey,Map<String,Transaction> prevTXs) throws BlockException{
        if(isCoinbase(tx)){
            return;
        }
     ...
     * @throws Exception
     */
    public static boolean verifyTransaction(Transaction transaction) throws BlockException{
        Map<String,Transaction> prevTXs = new HashMap<String, Transaction>();
        for(TxInput txInput:transaction.getvIns()){
    ...
    public static boolean verify(Transaction tx,Map<String,Transaction> prevTXs) throws BlockException{
        if (isCoinbase(tx)){
            return true;
        }
        for(TxInput txInput :tx.getvIns()){
